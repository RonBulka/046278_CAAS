///////////////////////////////////////////////// DO NOT CHANGE(except setting the device_id in main) ///////////////////////////////////////
...
int main(int argc, char **argv) {
    ...
    CUDA_CHECK( cudaMallocHost(&images_in, N_IMAGES * IMG_HEIGHT * IMG_WIDTH) );
    CUDA_CHECK( cudaMallocHost(&images_out_cpu, N_IMAGES * IMG_HEIGHT * IMG_WIDTH) );
    CUDA_CHECK( cudaMallocHost(&images_out_gpu, N_IMAGES * IMG_HEIGHT * IMG_WIDTH) );
